...
count.data <- Seurat::Read10X_h5("Visium_FFPE_Human_Prostate_Cancer_filtered_feature_bc_matrix.h5")
...
image_path <- "Visium_FFPE_Human_Prostate_Cancer_image.tif"
...
# pre-clustering
obj <- PreCluster(object = obj, method = 'louvain', res=1.1, seed = 1234)
plotSpatial(obj = obj, class = "cluster", size = 2)

saveRDS(obj, file='prostate_tuscan.rds')
